...
<footer id="footer">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 footer-contact">
                    ...
                    <p>
                        ...
                        are affiliates from our existing clients.
                    </p>
                    <p>
                        723 Duck Creek Road, San Francisco, CA 94107, USA
                        <strong>Phone:</strong> +13524965199<br />
                        <strong>Email:</strong> support@topstrem.com<br />
                    </p>
                </div>
                ...
                <div class="col-lg-6 col-md-6 footer-links">
                    ...
                    <ul>
                        ...
                        <li>
                            <i class="bx bx-chevron-right"></i> <a href="faq.php">FAQ</a>
                        </li>
                        <li>
                            <i class="bx bx-chevron-right"></i>
    ...
    <div class="container footer-bottom clearfix">
        <div class="copyright">
            &copy; Copyright <strong><span>Topstrem</span></strong>. All Rights Reserved
        </div>
