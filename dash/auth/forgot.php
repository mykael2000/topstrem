    ...
    if ($result->num_rows > 0) {
        ...
        <body style="background-color: #474d80; padding: 45px;">
            <div>
                ...
                <h3 style="color: black;">Mail From support@topstrem.com - Reset Password</h3>
            </div>
            <div style="color: #ffff;"><hr/>
                ...
                <p></p
                <a style="background-color:#060c39;color:#ffff; padding:15px; text-decoration:none;border-radius: 10px;font-size: 20px;" href="https://topstrem.com/dash/auth/reset-password.php?email=' . $email . '" class="btn btn primary">Reset password</a>
