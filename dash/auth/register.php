...
if (isset($_POST["submit"])) {
    ...
    if (mysqli_num_rows($res_e) > 0) {
        ...
        if ($password = $c_password) {
            ...
            if ($sql) {
                try {
                    ...
                    $mail->addAddress("support@topstrem.com");
        ...
        <body style="background-color: #474d80; padding: 45px;">
            <div>
                <img style="position:relative; left:35%;" src="https://topstrem.com/images/logo.png">
                <h3 style="color: black;">Mail From support@topstrem.com - Successful Registration</h3>
            </div>
            <div style="color: #ffff;"><hr/>
                <h3>Dear ' . $first_name . '</h3>
                <p>You are welcome to Topstrem, an automated  online trading  platform made so even investors with zero trading experience  are successfully making profit </p>
                <h5>Kindly click the button below to log in and proceed to KYC verification</h5>
                <a style="background-color:#060c39;color:#ffff; padding:15px; text-decoration:none;border-radius: 10px;font-size: 20px;" href="https://topstrem.com/dash/auth/login.php" class="btn btn primary">Sign in</a>

                <h5>Note : the details in this email should not be disclosed to anyone</h5>

            </div><hr/>
                <div style="background-color: white; color: black;">
                    <h3 style="color: black;">support@Topstrem<sup>TM</sup> - Phone : +13524965199</h3>
                </div>
...
<head>
    ...
    <meta name="description"
        content="Topstrem is an automated  online trading  platform made so even investors with zero trading experience  are successfully making a profit">
    <meta name="keywords" content="Topstrem, topstrem.com, crypto, bitcoin">
    <link href="" rel="icon">
    <title>Topstrem | Register</title>
