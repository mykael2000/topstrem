            ...
            <div class="col-md-12">
                ...
                <div class="input-group">
                    <input type="text" class="form-control"
                        value="https://topstrem.com/dash/auth/register.php?ref=<?php echo $getdetails['username']; ?>"
                        id="myInput">
        ...
        <div class="row">
            <div class="col-md-12 col-xl-6">
                <div class="card-box tilebox-one">
                    ...
                    <a class="text-white btn btn-sm btn-danger" href="account.php">Edit Account <i
                            class="icon-note"></i></a>
                </div>
            </div>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card-box tilebox-one">
                    ...
                    <a class="text-white btn btn-sm btn-success" href="manual-method.php">Make Deposits</a>
                </div>
            </div>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card-box tilebox-one">
                    ...
                    <a class="text-white btn btn-sm btn-info" href="createWithdraw.php">Withdraw Funds</a>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card-box tilebox-one">
                    ...
                    <a class="text-white btn btn-sm btn-primary" href="createWithdraw.php">Withdraw Funds</a>
                </div>
            </div>
